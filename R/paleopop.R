...
#'
#' The \code{paleopop} package is an extension of the \code{\link[poems:poems]} framework of \code{\link[R6:R6Class]{R6}} classes, which 
...
#'   \item \code{\link{paleopop_simulator}} function: Analogous to the \code{\link[poems:population_simulator]} 
...
#'   \item \code{\link{PaleoRegion}} class: Inherited from \code{\link[poems:Region]}, this class defines a 
...
#'     \code{\link[poems:SimulationModel]}, this class encapsulates the input parameters
